...
export default function NieuwDierPage() {
  ...
  const handleImageFilesChange = (
    ...
    if (files.length > MAX_IMAGES) {
      alert(`Je kan maximum ${MAX_IMAGES} foto's uploaden.`);
      event.target.value = "";
      return;
    }
        ...
        <div className={styles.wrapper}>
          <div className={styles.topBar}>
            <div>
              ...
              <p>
                Vul de gegevens in van het dier dat je wilt toevoegen aan het
                asiel.
              </p>
            </div>
          </div>
            ...
            <section className={styles.rightColumn}>
              ...
              <div className={styles.card}>
                ...
                <p className={styles.hint}>
                  Je kan maximum {MAX_IMAGES} foto’s uploaden. De eerste foto
                  wordt gebruikt als hoofdfoto op de dierenkaart.
                </p>
