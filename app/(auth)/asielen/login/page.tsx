		...
		<main className={styles.page}>
			<section className={styles.leftSide}>
				...
				<div className={styles.formWrapper}>
					...
					<p className={styles.intro}>Log in om dieren, aanvragen, afspraken en opvolgingen van jouw dierenasiel overzichtelijk te beheren.</p>
					...
					<p className={styles.registerText}>
						Nog geen asielaccount? <Link href="/asielen/register">Meld je hier aan</Link>
					</p>
				</div>
			</section>
			...
			<section className={styles.rightSide}>
				<div className={styles.imageCard}>
					<Image src="/images/asiel.jpg" alt="Dierenasiel" fill className={styles.sideImage} priority />
				</div>
			</section>
		</main>
	);
