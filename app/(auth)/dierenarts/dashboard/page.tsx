...
import {
  ...
  DierenartsDashboardAppointment,
  DierenartsDashboardPatient,
  DierenartsDashboardProfile,
...
export default function DierenartsDashboardPage() {
  const [profile, setProfile] = useState<DierenartsDashboardProfile | null>(
    null
  );
          ...
          <section className={styles.mainGrid}>
            <div className={styles.leftColumn}>
              <section className={styles.welcomeCard}>
                ...
                <p>
                  Er staan vandaag{" "}
                  <strong>{todayAppointments.length} patiënten</strong> op de
                  planning.
                </p>

                <Link href="/dierenarts/agenda">Bekijk agenda</Link>
              </section>
              ...
              <section className={styles.sectionBlock}>
                ...
                {appointmentRequests.length === 0 ? (
                  <div className={styles.emptyBox}>
                    Er zijn momenteel geen nieuwe afspraakaanvragen.
                  </div>
                ) : (
                      ...
                      <article key={request.id} className={styles.requestCard}>
                        <div>
                          ...
                          <p>
                            ...
                            {request.animal?.name || "Dier onbekend"}
                          </p>
                        </div>

                        <span>
                          {formatDate(request.start_at)} om{" "}
              ...
              <section className={styles.sectionBlock}>
                ...
                {patients.length === 0 ? (
                  <div className={styles.emptyBox}>
                    Er zijn nog geen patiënten gekoppeld aan dit dierenasiel.
                  </div>
                ) : (
                    ...
                    {patients.map((patient) => (
                      <article key={patient.id} className={styles.patientItem}>
                        ...
                        <div>
                          <h3>{patient.name}</h3>
                          <p>
                            {patient.breed || patient.species || "Dier"} ·{" "}
                            {patient.status || "status onbekend"}
                          </p>
                        </div>
            ...
            <div className={styles.modal}>
              ...
              <label>
                ...
                <textarea
                  ...
                  placeholder="Extra info over deze taak..."
                />
              </label>
