...
import {
  getMyAnimalApplications,
  MyAnimalApplication,
} from "@/lib/animals/getMyAnimalApplications";
      ...
      <main className={styles.page}>
        {loading ? (
          ...
          <section className={styles.emptyState}>
            ...
            <p>
              Bekijk welke dieren tijdelijk opvang zoeken en toon interesse in
              een dier dat bij jou past.
            </p>
            ...
            {applications.map((application) => {
              ...
              return (
                <article key={application.id} className={styles.card}>
                  <Link href={`/dieren/${animal.id}`} className={styles.imageLink}>
                    <img
                    ...
                    <div className={styles.tagsTop}>
                      <span className={styles.greenTag}>
                        🗓{" "}
                        {nights
                          ? `${nights} dagen verblijf`
                          : animal.expected_duration || "Verblijf onbekend"}
                      </span>
