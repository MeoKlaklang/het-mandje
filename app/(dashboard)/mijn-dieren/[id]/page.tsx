...
export default function MijnDierDetailPage() {
  ...
  async function loadApplication() {
    ...
    const animal = application?.animals;
    const startDate =
      application?.start_date || animal?.available_from || null;
  ...
  const images = useMemo(() => {
    ...
    const extraImages = [...(animal.animal_images || [])]
      .sort((a, b) => Number(a.image_order || 0) - Number(b.image_order || 0))
      .map((image) => image.image_url);

    return extraImages.length
      ? extraImages
      : [animal.image_url || "/images/dog3.jpg"];
  }, [application]);
  ...
  const visibleMedications = useMemo(() => {
    return sortedMedications.slice(0, 3);
  }, [sortedMedications]);
  ...
  const handleCreateNote = async () => {
    ...
    if (application.status !== "goedgekeurd") {
      alert(
        "Je kan pas een notitie toevoegen wanneer je aanvraag is goedgekeurd."
      );
      return;
    }
  ...
  const startDate = application.start_date
    ...
    : animal.available_from
    ? new Date(animal.available_from)
    : null;

  const endDate = application.end_date
    ? new Date(application.end_date)
    : animal.available_until
    ? new Date(animal.available_until)
    : null;

  const nights = getNights(
    application.start_date || animal.available_from,
    application.end_date || animal.available_until
  );
        ...
        <div className={styles.container}>
          <section className={styles.leftColumn}>
            ...
            <div className={styles.gallery}>
              <div className={styles.largeImage}>
                ...
                <div
                  className={`${styles.statusOverlay} ${getStatusClass(
                    application.status
                  )}`}
                >
              ...
              <div className={styles.wideImage}>
                <img
                  src={images[1] || images[0] || "/images/dog3.jpg"}
                  alt=""
                />
              </div>
              ...
              <div className={styles.smallImage}>
                <img
                  src={images[2] || images[0] || "/images/dog3.jpg"}
                  alt=""
                />
              </div>
              ...
              <div className={styles.smallImage}>
                <img
                  src={images[3] || images[0] || "/images/dog3.jpg"}
                  alt=""
                />
              </div>
            </div>
            ...
            <p className={styles.shelterName}>
              {shelter?.name || "Dierenasiel onbekend"}
            </p>

            <div
              className={`${styles.statusCard} ${getStatusClass(
                application.status
              )}`}
            >
            ...
            <section className={styles.notesSection}>
              <div className={styles.sectionHeader}>
                ...
                {sortedNotes.length > 0 && (
                  <Link href={`/mijn-dieren/${application.id}/notities`}>
                  ...
                  {visibleNotes.map((note) => (
                    <article key={note.id} className={styles.noteCard}>
                      <div className={styles.noteDate}>
                        {formatShortDate((note as any).created_at)}
                      </div>
            ...
            <section className={styles.medicationSection}>
              <div className={styles.sectionHeader}>
                ...
                {sortedMedications.length > 0 && (
                  <Link href={`/mijn-dieren/${application.id}/medicatie`}>
                    Bekijk alle medicatie
                  </Link>
                )}
              </div>
                      ...
                      >
                        <div className={styles.medicationDate}>
                          {formatShortDate(medication.start_date) ||
                            formatShortDate((medication as any).created_at)}
                        </div>
          ...
          <aside className={styles.rightColumn}>
                  ...
                  return (
                    <span
                      ...
                      className={[
                        ...
                        isStart || isEnd ? styles.activeDay : "",
            ...
            <section className={styles.descriptionCard}>
              ...
              <p>
                {animal.description ||
                  "Er is nog geen uitgebreide beschrijving beschikbaar."}
              </p>
            ...
            <div className={styles.noteModal}>
              ...
              <label>
                ...
                <input
                  ...
                  placeholder="Bijv. Eten en drinken"
                />
              </label>
