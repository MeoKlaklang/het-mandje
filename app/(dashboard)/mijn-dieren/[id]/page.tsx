          ...
          <section className={styles.leftColumn}>
            ...
            <section className={styles.notesSection}>
              <div className={styles.sectionHeader}>
                ...
                {(application.animal_notes || []).length > 3 && (
            ...
            <section className={styles.medicationSection}>
              <div className={styles.sectionHeader}>
                ...
                {(application.animal_medications || []).length > 3 && (
          ...
          <aside className={styles.rightColumn}>
            <div className={styles.calendarCard}>
              ...
              <div className={styles.stayInfo}>
                {nights ? `${nights} nachten verblijf` : animal.expected_duration}
              </div>

              <button
                type="button"
                className={styles.updateButton}
                disabled={application.status !== "goedgekeurd"}
              >
                {application.status === "goedgekeurd"
                  ? "Update toevoegen"
